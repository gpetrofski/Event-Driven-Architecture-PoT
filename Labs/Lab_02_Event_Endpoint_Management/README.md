...
You have the possibility to change the Topic name that will be displayed to the application developer. For this lab, we will keep it as is. 6. click on the "Add topic" button after that you selected the topic that you want to add.
...
- Disconnect to Kafka - Change the TOPIC name to **CANCELLATIONS** - Click on the button **connect to kafka**
...
- to group TOPICs in _Product_ that is life cycled.
...
| ---------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Event Processing | [LAB 03](../Lab_03_Event_Processing/) | Learn how Event Processing allows you to gain insights from real-time data, without the need for deep technical skills |
